...
public class BBTabBar {
	...
	private int focus;
	private BBTab unfocusTab, focusTab;
	private int tabItemPosX[];
	private BBTabBarListener tabListener;
	
	BBTabBar(String tabs[], int tabBarWidth, BBTab unfocus, BBTab focus) {
	...
	void setTabListener(BBTabBarListener l) {
		tabListener = l;
	}
