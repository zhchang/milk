...
public class BBPopMenu {
	...
	private static BBPopMenu popMenu;
	...
	public static BBPopMenu getInstance() {
		if (popMenu == null) {
			popMenu = new BBPopMenu();
		}
		return popMenu;
	}
...
//		}
	...
	void draw(MilkGraphics g) {
		g.setFont(font);
		setMenuFrameRect();
		menuFrame = BBResourceManager.menuFrame;
		menuUnFocus = BBResourceManager.btnUnFocus;
		menuFocus = BBResourceManager.focusRect;
