...
public class J2meSelectBox {
	...
	private J2meSelectBoxListener selectBoxListener;

	J2meSelectBox(MilkApp factory) {
	...
	void setItemSelectBoxListener(J2meSelectBoxListener l) {
		selectBoxListener = l;
	}
	...
	void draw(MilkGraphics g) {
		...
		g.setFont(font);
		focusRect = J2meResourceManager.focusRect;
		unfocusRect = J2meResourceManager.unfocusRect;
