...
public class J2mePopMenu {
	...
	private static final MilkFont font = J2meHallScreen.font;
	...
	private static J2mePopMenu popMenu;
	...
	public static J2mePopMenu getInstance() {
		if (popMenu == null) {
			popMenu = new J2mePopMenu();
		}
		return popMenu;
	}

	public void initPopMenu(String info, MenuItem items[], int toId,
			String toName, PopMenuListener l) {
...
//		}
	...
	void draw(MilkGraphics g) {
		g.setFont(font);
		setMenuFrameRect();
		menuFrame = J2meResourceManager.menuFrame;
		menuUnFocus = J2meResourceManager.btnUnFocus;
		menuFocus = J2meResourceManager.focusRect;
