...
public class J2meFaceScreen extends Scene {

	private static final int FACE_NUM_LINE = 5;
	private static MilkFont font = J2meHallScreen.font;
	...
	private J2meFaceListener faceListener;
	private int focus;
	...
	public J2meFaceScreen(MilkApp factory) {
...
//		g.setColor(0x000000);
//		g.drawString(freeface, bbX + 20, FREE_FACE_TAB_Y, 0);
//
...
//	}
	...
	public void setFaceInputListener(J2meFaceListener l) {
		faceListener = l;
	}
...
//		}
	...
	public void show(MilkDisplayable displayable) {
		backScene = Core.getInstance().getCurrentScene();
		Core.getInstance().replaceScene(this);
		backScreen = factory.getCurrentDisplay();
		factory.switchDisplay(displayable);
	}
	...
	protected void draw(MilkGraphics g) {
		...
		if (backGround == null) {
			backGround = new J2meBackGround(width, height);
		}
