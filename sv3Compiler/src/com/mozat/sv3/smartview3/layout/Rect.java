...
public class Rect {
	...
	// return new Rect(x + offset.x + padding[3], y + offset.y + padding[0],
	// width - padding[1] - padding[3], height
	// - padding[0] - padding[2]);
	// }
	...
	// return new Rect(x + padding[3], y + padding[0], width - padding[1] -
	// padding[3], height - padding[0]
	// - padding[2]);
	// }

	// public Rect toRectWithOffsetAndPadding(Rect offset, short[] padding1,
	// short[] padding2) {
	// return new Rect(x + offset.x + padding1[3] + padding1[3], y + offset.y +
	// padding1[0] + padding2[0], width
	// - padding1[1] - padding1[3] - padding2[1] - padding2[3], height -
	// padding1[0] - padding1[2]
	// - padding2[0] - padding2[2]);
	// }

	// public Rect toRectWithOffsetAndBorder(Rect offset, short[] border) {
	// return new Rect(x + offset.x + border[3] / 2, y + offset.y + border[0] /
	// 2,
	// width - (border[1] + border[3]) / 2, height - (border[0] + border[2]) /
	// 2);
	// }
	...
	// return "(" + x + "+" + offset.x + "," + y + "+" + offset.y + "," + width
	// + "," + height + ")";
	// }
}
